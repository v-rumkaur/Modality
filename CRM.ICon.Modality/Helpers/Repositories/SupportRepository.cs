namespace CRM.ICon.Modality.Helpers.Repositories
{
    ...
    using System.Net.Http.Headers;  
        ...
        using System.Web;
        using ICompassService = Services.Modality.ICompassService;
        ...
        public class SupportRepository : ISupportRepository
        {
            ...
            {
                var managedIdentityId = this.configuration.GetStringValue(Constants.Common.KeyvaultConfigSectionName, Constants.Common.ManagedIdentityId);
